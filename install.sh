...
# orchestrator remains a skill (Skill tool / `Skill: story-council`).
...
if [[ "$ACTION" == "uninstall" ]]; then
  echo "==> Uninstalling Novel Council Layer agents/skills from:"
...
echo "==> Installing Novel Council Layer to:"
...
echo "      Skill: story-council              # council orchestrator"
echo "      Agent: plot-architecture, ...     # evaluators launch as subagents (add -ja/-zh for language variants)"
echo ""
