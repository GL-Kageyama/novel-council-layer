...
- `agents/{name}.md` — the authoritative source of the evaluator agents (13). Launched as independent subagents acting as persona-based experts
...
| `utils/render_report.py` | Visual rendering of the Story Report (13-dimensional bar chart, category badges, conflicts between dimensions). Saves as a Markdown document with `-o report.md`, displays all individual reports with `--individuals` |
