...
<!-- i18n-version: 1.0.0 | canonical: narrative-originality.md | translated: 2026-08-11 | lang: ja -->
...
7. **不一致予測**: Anti-Generic Story Filter（月並みの検出）や Plot Architecture Evaluator（設計の巧拙）との対立を予測する。
...
| 14 | `expected_disagreement_points` | array | 任意 | `[{"evaluator_type": "anti-generic-story-filter", "predicted_stance": "..."}, ...]`（省略可） |
