**Language:** [English](../evaluator-taxonomy.md) | 日本語 | [中文](../zh/evaluator-taxonomy.md)
...
| 評価者 | 視点 | 担当サブドメイン |
|--------|------|-----------------|
| Anti-Generic Story Filter | クリシェ・類型・予定調和の検出（横断） | 全サブドメイン |
...
| 評価者 | 視点 |
|--------|------|
| Anti-Generic Story Filter | 凡庸性の除去（全評価者に横断的に働く） |
...
| Anti-Generic Story Filter | クリシェ・類型・予定調和に堕していないか？ |
